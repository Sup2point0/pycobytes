...
>>> timeit.timeit("result = [], for x in numbers: if x > 0: result.append(x ** 2)", "numbers = list(range(200))")

>>> timeit.timeit("result = [x ** 2 for x in numbers if x > 0]", "numbers = list(range(200))")
