...
I have planned all the issues until #40, so it’s probably coming! That being said, suggestions and ideas are always welcome – just drop a comment in a [GitHub Discussion](https://github.com/Sup2point0/pycobytes/discussions) :D
...
Tutorials, walkthroughs and documentation, but above all, actually developing and experimenting in my own projects. [More details on my profile](https://sup2point0.github.io/sup/dev?open=python).
